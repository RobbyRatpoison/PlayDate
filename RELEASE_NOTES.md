...
- Added an in-app Tutorial covering most of PlayDate: Getting Started, Home & Shelves, Library & Filters, Pick 6, PAGYWOSG, Plugins, Emulators, and Gamepad & Settings. Shows automatically on first setup (or once for existing installs), and anytime after from the hamburger menu.
