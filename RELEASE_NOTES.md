...
- Added an opt-in "Require double-click to launch/install" setting (hamburger menu → Library → Launching), off by default, covering Library, Home, and Pick 6. Helps avoid accidentally launching or installing a game from a stray click. (suggested by ArchelonGaming)
