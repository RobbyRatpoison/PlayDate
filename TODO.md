...
- **Library UI polish** — group-by functionality, reorder dropdown lists
...
- **HLTB integration** — data reliability concerns; edit modal has a "Search HLTB ↗" link as a stopgap
